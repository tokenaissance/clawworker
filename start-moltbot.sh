...
if (isOpenRouter) {
    ...
    config.agents.defaults.models['openrouter/anthropic/claude-haiku-3.5'] = { alias: 'Claude Haiku 3.5' };
    ...
    config.agents.defaults.models['openrouter/openai/o1'] = { alias: 'OpenAI o1' };
    config.agents.defaults.models['openrouter/google/gemini-2.0-flash-exp:free'] = { alias: 'Gemini 2.0 Flash' };
